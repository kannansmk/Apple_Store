...
<body>
 ...
 <div class="container">
    ...
    <p>
        <?php 
			$sql="SELECT * FROM laptops WHERE l_id='{$_GET["id"]}'";
			$res=$conn->query($sql);
			if($res->num_rows>0)
			{
            ...
            <p><img src="../../images/laptop full size.png" alt="mobile img"></p>
    ...
    <div class="first">
        <div class="second">
            ...
            if(isset($_POST['addCart'])){
                ...
                $sql="UPDATE laptops SET qty='$fqty' WHERE l_id ='{$_GET["id"]}'";
