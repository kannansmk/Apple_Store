...
<head>
    ...
    <title>Delete-Product(Mobile)</title>
...
<body>
    <p>
        ...
        <?php
            ...
            if (isset($_POST['sub'])){
            // from values delete in database
            $m_id=$_POST['m_id'];
        
            $sql= "DELETE FROM `mobiles` WHERE p_id='$m_id'";
    ...
    <div class="indiv">
        ...
        <h2>Delete A Mobile</h2><hr>
        <br><br>
        <label for="m_id">M-ID</label><input type="text" name="m_id" required><br><br>
        <button type="submit" name="sub">Delete Mobile</button>
        <br><br><br>
        <?php echo"$dbs";?>
        </form>
