...
<head>
    ...
    <title>Edit-Product(Mobile)</title>
...
<body>
    <p>
        ...
        <?php
            ...
            $pname=$_POST['pname'];
            $price=$_POST['price'];
            $ramrom=$_POST['ram_rom'];
            $pro=$_POST['processer'];
            $rcam=$_POST['rcamera'];
            $fcam=$_POST['fcamera'];

        
            $sql= "UPDATE mobiles SET product_name='$pname',price='$price',ram_rom='$ramrom',processer='$pro',rear_camera='$rcam',front_camera='$fcam' WHERE p_id='$m_id' ";
    ...
    <div class="indiv">
        ...
        <br><br>
        <h3><u>Enter A Editing Mobile M_id</u></h3>
        <label for="m_id">M_id:</label><input type="text" name="m_id" required>
        <br><br>
        <br><br>
        ...
        <button type="submit" name="sub">Edit Mobile</button>
        <br><br><br>
        <?php echo"$dbs";?>
        </form>
    </div>
