...
<head>
    ...
    <title>Delete-Product(Laptop)</title>
...
<body>
    <p>
        ...
        <?php
            ...
            $sql= "DELETE FROM `laptops` WHERE l_id='$l_id'";
    ...
    <div class="indiv">
        ...
        <h2>Delete A laptop</h2><hr>
        <br><br>
        <label for="l_id">L-ID</label><input type="text" name="l_id" required><br><br>
        <button type="submit" name="sub">Delete laptop</button>
        <br><br><br>
        <?php echo"$dbs";?>
        </form>
