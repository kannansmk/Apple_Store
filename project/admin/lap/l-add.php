...
<head>
    ...
    <title>Add-Product(Laptop)</title>
...
<body>
    <p>
        ...
        <?php
            ...
            if (isset($_POST['sub'])){
                ...
                $sql = "INSERT INTO laptops(`l_id`, `product_name`, `price`, `ram`, `ssd`, `processor`, `display`) VALUES ('','$pname','$price','$ram','$ssd','$pro','$display')";
    ...
    <div class="indiv">
        ...
        <button type="submit" name="sub">Add Laptop</button>
        <br><br><br>
        <?php echo"$dbs";?>
        </form>
    </div>
