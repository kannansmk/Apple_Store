...
<head>
    ...
    <title>Edit-Product(Other)</title>
...
<body>
    <p>
        ...
        <?php
            ...
            $sql= "UPDATE otherproducts SET product_name='$pname',price='$price',p_1='$p1',p_2='$p2',P_3='$p3' WHERE o_id ='$o_id'";
    ...
    <div class="indiv">
        ...
        <h2>Edit A Product Details</h2><hr>
        <br><br>
        <h3><u>Enter A Editing Product O_id</u></h3>
        <label for="o_id">O_id:</label><input type="text" name="o_id" required>
        <br><br>
        <br><br>
        ...
        <button type="submit" name="sub">Edit Product</button>
        <br><br><br>
        <?php echo"$dbs";?>
        </form>
    </div>
